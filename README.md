...
Total Quantity: Tracks the volume of items sold, helping to understand inventory turnover and scale.

Average Order Value (Sum of Average): Measures the average amount spent per transaction, which is crucial for identifying customer spending patterns.
